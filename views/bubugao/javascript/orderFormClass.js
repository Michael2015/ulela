...
function orderFormClass()
{
	...
	{
		art.dialog.open(creatUrl("block/address/id/"+addressId + "?is_cbe=" + is_cbe), //dyg_jzw 20160613 添加跨境电商地址
		{
			"id":"addressWindow",
			"title":"修改收货地址",
	...
	{
		art.dialog.open(creatUrl("block/address" + "?is_cbe=" + is_cbe), //dyg_jzw 20160613 添加跨境电商地址
		{
			"id":"addressWindow",
			"title":"添加收货地址",
			"ok":function(iframeWin, topWin){
